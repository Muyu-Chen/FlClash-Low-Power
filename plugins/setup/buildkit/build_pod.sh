...
# Xcode strips PATH to a minimal set. Prefer the project's pinned FVM SDK.
export PATH="$PROJECT_DIR/.fvm/flutter_sdk/bin:/opt/homebrew/bin:/usr/local/bin:${HOME}/fvm/default/bin:${HOME}/.pub-cache/bin:${PATH}"
